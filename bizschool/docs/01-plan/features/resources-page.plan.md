...
> **Summary**: 강의 수강에 필요한 자료(강의교안 PDF 등)를 다운받을 수 있는 기능 구현. 강의별 자료는 인프런 스타일 강의 플레이어 페이지(`/course/[id]`)의 사이드바 "강의자료" 탭에서 제공. 일반 자료실(`/resources`)은 별도 구현 예정.
>
> **Project**: BIZSCHOOL
> **Version**: 0.2
> **Author**: allen
...
강의 수강생이 강의교안(PDF), 실습 파일, 참고 서식 등 수업에 필요한 자료를 한 곳에서 검색하고 다운로드할 수 있는 "자료실" 페이지를 제공한다.

### 1.2 Background

현재 BIZSCHOOL은 세무회계, 재산제세, 공개교육 등 다양한 강의를 제공하고 있으나, 강의에서 사용하는 교안 PDF나 실습 파일을 다운로드할 수 있는 전용 페이지가 없다. 수강생이 수업 전에 교안을 미리 준비하거나, 수업 후 복습 자료를 찾기 위한 통합 자료실이 필요하다.
...
- [x] 카테고리 필터 탭 (전체 / 강의교안 / 실습파일 / 세무서식 / 참고자료)
- [x] 검색 기능 (제목 키워드 검색)
...
| FR-02 | 카테고리 필터: "전체", "강의교안", "실습파일", "세무서식", "참고자료" 탭 클릭 시 필터링 | High | Pending |
...
│  │ │ [강의교안]  NEW                            │   │    │
│  │ │ 2026 세무회계 실무 강의교안                  │   │    │
│  │ │ PDF · 2.3 MB · 2026.03.20      [⬇️ 다운]  │   │    │
│  │ └───────────────────────────────────────────┘   │    │
│  │ ┌───────────────────────────────────────────┐   │    │
│  │ │ [세무서식]                                 │   │    │
│  │ │ 부가가치세 신고서 양식                      │   │    │
│  │ │ XLSX · 156 KB · 2026.03.15     [⬇️ 다운]  │   │    │
│  │ └───────────────────────────────────────────┘   │    │
│  └─────────────────────────────────────────────────┘    │
│                                                         │
│  ┌─────────────────────────────────────────────────┐    │
...
export type ResourceCategory = "강의교안" | "실습파일" | "세무서식" | "참고자료";
...
카테고리별 분포:
- 강의교안: 6건 (세무회계, 재산제세, 법인세, 원가관리 등)
- 실습파일: 4건 (엑셀 실습, 전산세무 실습 등)
- 세무서식: 4건 (부가세 신고서, 원천징수영수증 등)
- 참고자료: 4건 (세법 개정 요약, 실무 가이드 등)
...
- 카테고리: 컬러 뱃지 (강의교안=blue, 실습파일=green, 세무서식=primary, 참고자료=gray)
...
```
/resources                           → 전체, 1페이지
/resources?category=강의교안          → 강의교안 필터
/resources?search=세무                → 검색
/resources?category=실습파일&page=2   → 카테고리 + 페이지
```
