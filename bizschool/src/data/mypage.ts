...
export const mockInquiries: Inquiry[] = [
  ...
  },
  {
    ...
    content: "현장 강의 수료 후 수료증은 어떻게 발급받을 수 있나요?",
    status: "answered",
...
export const mockClaimItems: ClaimItem[] = [
  ...
  },
  {
    ...
    product: {
      name: "회계원리 - 비전공자를 위한 회계 입문서",
      description: "회계원리 - 비전공자를 위한 회계 입문서, 1권",
      imageUrl: "/images/books/book-3.jpg",
      quantity: 1,
      price: 27000,
    },
    refundExpectedDescription: "3/14(목) 이내",
  ...
  },
  {
    ...
    product: {
      name: "퍼포먼스 마케팅 - 데이터 기반 디지털 마케팅 전략",
      description: "퍼포먼스 마케팅 - 데이터 기반 디지털 마케팅 전략, 1권",
  ...
  },
  {
    ...
    product: {
      name: "제로 투 원 - 스탠퍼드 대학 스타트업 최고 명강의",
      description: "제로 투 원 - 스탠퍼드 대학 스타트업 최고 명강의, 1권",
  ...
  },
  {
    ...
    product: {
      name: "그릿 - 열정과 끈기의 힘",
      description: "그릿 - 열정과 끈기의 힘, 2권",
      imageUrl: "/images/books/book-4.jpg",
      quantity: 2,
      price: 30600,
    },
    refundExpectedDescription: "2/10(월) 이내",
    refundMethod: "카드사 환불 완료 예정",
  },
  {
    id: "claim-005",
    ...
    product: {
      name: "블리츠스케일링 - 빠르게 성장하는 기업의 비밀",
      description: "블리츠스케일링 - 빠르게 성장하는 기업의 비밀, 2권",
      imageUrl: "/images/books/book-1.jpg",
      quantity: 2,
      price: 39600,
    },
    refundExpectedDescription: "1/10(금) 이내",
    refundMethod: "카드사 환불 완료 예정",
  },
  {
    id: "claim-006",
    ...
    product: {
      name: "마케팅 불변의 법칙 - 22가지 마케팅 원칙",
      description: "마케팅 불변의 법칙 - 22가지 마케팅 원칙, 1권",
      imageUrl: "/images/books/book-2.jpg",
      quantity: 1,
      price: 15300,
    },
    refundExpectedDescription: "1/3(금) 이내",
    refundMethod: "카드사 환불 완료 예정",
  },
];
...
export const mockCancelDetail: CancelDetailInfo = {
  ...
  cancelReceiptDate: "2026/3/12",
  cancelReceiptNumber: "1671085",
  cancelCompleteDate: "2026/3/12",
  cancelReason: "필요 없어짐 (단순 변심)",
  refund: {
    productAmount: 27000,
    shippingFee: 0,
    returnFee: 0,
    refundMethod: "무통장입금 환불",
    refundAmount: 27000,
    isCompleted: true,
  },
};
...
export const mockReturnDetail: ReturnDetailInfo = {
  ...
  shippingInfo: {
    carrier: "CJ대한통운",
    trackingNumber: "640285739104",
  },
  pickupSchedule: {
    pickupDate: "2026/3/10(월)",
    pickupRequest: "door",
  },
  returnReason: "내용이 기대와 달라서 (단순 변심)",
  refund: {
    productAmount: 16200,
    shippingFee: 0,
    returnFee: 0,
    refundMethod: "신용카드 / 일시불",
    refundAmount: 16200,
    isCompleted: false,
  },
};
