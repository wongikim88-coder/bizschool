...
export const expertConsultations: ExpertConsultation[] = [
  ...
  },
  {
    ...
    answer: {
      ...
      expertTitle: "세무사",
      content:
        "법인세 중간예납은 두 가지 방법 중 선택 가능합니다.\n\n1) 직전 사업연도 기준: 직전 법인세액 × 6/12\n2) 중간결산 기준: 상반기 실적 기준 법인세 산출\n\n올해 상반기 실적이 전년 대비 크게 감소했다면 중간결산 방식이 유리합니다. 반대로 실적이 비슷하거나 증가했다면 직전연도 기준이 간편합니다. 중간예납 기한은 상반기 종료일 다음 달 말일(8월 31일)입니다.",
      answeredAt: "2026.03.21",
    },
  },
  {
  ...
  },
  {
    ...
    answer: {
      ...
      expertTitle: "인사노무사",
      content:
        "최저임금법 제5조에 따라 수습 사용 중인 근로자로서 수습 시작일부터 3개월 이내인 경우, 최저임금의 10%를 감액할 수 있습니다.\n\n다만 조건이 있습니다:\n1) 1년 이상의 근로계약을 체결한 경우에만 가능\n2) 단순노무직(고시 직종)은 감액 불가\n3) 근로계약서에 수습기간과 급여 조건을 명시해야 함\n\n최저임금 이상이라면 회사 내규로 90% 지급은 가능합니다.",
      answeredAt: "2026.03.20",
    },
  },
  {
