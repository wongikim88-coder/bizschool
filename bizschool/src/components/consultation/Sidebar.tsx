...
import { Menu, SquarePen, MessageSquare, Search } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="border-b border-[var(--color-border)] px-2 py-2">
          ...
          <button
            onClick={onNewChat}
            className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-[var(--color-dark)] transition-colors hover:bg-gray-100"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-[var(--color-muted)] transition-colors hover:bg-gray-100"
          >
